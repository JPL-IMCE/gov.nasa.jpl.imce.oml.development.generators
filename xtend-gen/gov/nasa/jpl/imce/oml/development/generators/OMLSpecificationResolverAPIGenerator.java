...
public class OMLSpecificationResolverAPIGenerator extends OMLUtilities {
  ...
  public String generateExtentContainerClassFile(final EClass eClass, final Iterable<EClass> allEClasses) {
    String _xblockexpression = null;
    {
      ...
      _builder.newLine();
      _builder.append("import scala.{Option,None,Some,StringContext}");
      _builder.newLine();
      _builder.newLine();
      {
        boolean _hasElements = false;
      ...
      _builder.append("(");
      {
        ...
        for(final EClass em : _filter) {
          ...
          _builder.newLineIfNotEmpty();
          _builder.append("  ");
          _builder.append(": Map[taggedTypes.ModuleUUID, ");
          String _name_5 = em.getName();
          _builder.append(_name_5, "  ");
          _builder.append("] ");
          _builder.newLineIfNotEmpty();
          _builder.append("  ");
          _builder.append("= HashMap.empty[taggedTypes.ModuleUUID, ");
        ...
        for(final EStructuralFeature c : containers) {
          ...
          _builder.append(", ");
          {
            ...
            if (_equals) {
              ...
              _builder.append("Set[");
              String _name_10 = c.getEType().getName();
              _builder.append(_name_10, "  ");
              _builder.append("]");
            }
          }
          ...
          String _name_11 = OMLUtilities.EClassContainer(c).getName();
          _builder.append(_name_11, "  ");
          _builder.append(", ");
          {
            ...
            if (_equals_1) {
              ...
              _builder.append("Set[");
              String _name_13 = c.getEType().getName();
              _builder.append(_name_13, "  ");
              _builder.append("]");
            }
          }
      ...
      _builder.newLineIfNotEmpty();
      {
        ...
        for(final EStructuralFeature c_1 : containers) {
          ...
          _builder.append("Of");
          String _name_14 = c_1.getEType().getName();
          _builder.append(_name_14);
          _builder.newLineIfNotEmpty();
          _builder.append("  ");
          _builder.append(": Map[");
      ...
      _builder.newLine();
      _builder.append("  ");
      _builder.append("= lookupTerminologyBox(uuid) orElse");
      _builder.newLine();
      _builder.append("  ");
      _builder.append("lookupDescriptionBox(uuid)");
      _builder.newLine();
      _builder.append("  ");
      _builder.newLine();
      _builder.append("  ");
      ...
      _builder.newLine();
      _builder.append("  ");
      _builder.append("= lookupTerminologyGraph(uuid) orElse ");
      _builder.newLine();
      _builder.append("  ");
      ...
      _builder.newLine();
      _builder.append("  ");
      _builder.append("def lookupPredicate(uuid: taggedTypes.PredicateUUID)");
      _builder.newLine();
      _builder.append("  ");
      _builder.append(": Option[Predicate]");
      _builder.newLine();
      _builder.append("  ");
      _builder.append("= forwardPropertyByUUID.get(uuid.asInstanceOf[taggedTypes.ForwardPropertyUUID]) orElse");
      _builder.newLine();
      _builder.append("    ");
      _builder.append("inversePropertyByUUID.get(uuid.asInstanceOf[taggedTypes.InversePropertyUUID]) orElse");
      _builder.newLine();
      _builder.append("    ");
      _builder.append("lookupTerminologyBoxStatement(uuid.asInstanceOf[taggedTypes.TerminologyBoxStatementUUID]) match {");
      _builder.newLine();
      _builder.append("    ");
      _builder.append("case Some(p: Predicate) =>");
      _builder.newLine();
      _builder.append("      ");
      _builder.append("Some(p)");
      _builder.newLine();
      _builder.append("    ");
